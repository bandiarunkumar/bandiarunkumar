...
ROWS = [
    ...
    ("kv", "Frameworks", "FastAPI, Flask, React, Next.js"),
    ("kv", "Tools", "Docker, Git, GitHub Actions"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Passionate about automating workflows"),
    ("bul", "Building premium and interactive web apps"),
]
